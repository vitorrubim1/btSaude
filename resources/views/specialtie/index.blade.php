...
<div class="content">
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <a href="{{url("specialtie/create")}}" class="btn btn-info"><i class="fas fa-plus"></i> Adicionar</a>
            </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{url("specialtie/".$record->id)}}"><i class="fas fa-eye"></i> Visualizar</a>
                                                        <a class="dropdown-item" href="{{url("specialtie/".$record->id.'/edit')}}"><i class="fas fa-pencil-alt"></i> Editar</a>
                                            ...
                                            <div class="modal-dialog modal-danger" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{route('specialtie.destroy',$record->id)}}" method="post">
